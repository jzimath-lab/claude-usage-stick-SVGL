#pragma once
// Parser do JSON do bridge do Codex — PURO (sem deps Arduino), para ser testável
// no host. Incluído por codex_api.cpp (firmware) e por test/parse_test.cpp (host),
// garantindo que o teste cobre o MESMO código que roda no device.
//
// Estratégia: JSON pequeno e de forma fixa; não vale trazer uma lib. Acha a chave,
// pula ':'/espaços, lê o que vier. Funções `static` (cada TU tem sua cópia).
#include <stdint.h>
#include <stdio.h>
#include <string.h>
#include <stdlib.h>
